...
def scrape_ycombinator():
    ...
    try:
        ...
        # Find job cards (YC's HTML structure)
        job_links = soup.find_all('a', href=True, limit=30)
        ...
        print(f"Found {len(jobs)} jobs from YC")
